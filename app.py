...
if uploaded_file is not None:
    try:
        ...
        with st.spinner('Processing data...'):
            ...
            st.dataframe(rep_analysis[['Rep_Name', 'Sampling Rate (%)', 'Customer_Satisfaction_Score', 
                                       'First_Call_Resolved', 'Call_Handle_Time', 'Recognition Integrity']])
            ...
            summary_df = pd.DataFrame({
                ...
                'Goal': [
                    'Undefined' if goals["Sampling Rate (%)"] == 0 else goals["Sampling Rate (%)"],
